...
def create_item(item: schemas.ItemCreate, db: Session = Depends(database.get_session)):
...
def create_item_for_user(
    user_id: int, item: schemas.ItemCreate, db: Session = Depends(database.get_session)
):
    try:
